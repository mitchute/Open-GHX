...
class TestGHXArray(unittest.TestCase):
    ...
    def test_BaseGHX_dens(self):
        ...
        # init
        A = ghx.BaseGHX(ghx_file_path, config_file_path, csv_file_path, False)  # pass 'False' to suppress output
    ...
    def test_BaseGHX_interp_g_funcs(self):
    ...
    def test_BaseGHX_calc_pipe_resistance(self):
        """
    ...
    def test_BaseGHX_calc_bh_average_thermal_resistance(self):
        """
    ...
    def test_BaseGHX_calc_bh_total_internal_thermal_resistance(self):
        """
    ...
    def test_BaseGHX_calc_bh_effective_resistance(self):
        """
    ...
    def test_GHXArrayDynamicAggBlocks_init(self):
        """
        ...
        # init
        A = ghx.GHXArrayDynamicAggBlocks(ghx_file_path, config_file_path, csv_file_path,
                                         False)  # pass 'False' to suppress output
    ...
    def test_GHXArrayDynamicAggBlocks_merge_agg_load_objs(self):
        ...
        # init
        A = ghx.GHXArrayDynamicAggBlocks(ghx_file_path, config_file_path, csv_file_path, False)  # pass 'False' to suppress output
    ...
    def test_GHXArrayDynamicAggBlocks_aggregate_load(self):
